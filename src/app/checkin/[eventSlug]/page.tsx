...
export default function CheckInPage() {
  ...
  const processCheckIn = async (qrData: string) => {
    ...
    try {
      ...
      // Flux standardisé: toujours passer par les conditions d'utilisation
  ...
  return (
    <div className="checkin-page check-in-page">
      ...
      <div className="checkin-brand-logo">
        {/* Logo moderne similaire à celui de l'exemple */}
        <svg width="100%" height="100%" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="100" cy="100" r="85" fill="#000000" stroke="#75B025" strokeWidth="2"/>
          <path d="M100 50
                   A 40 40 0 1 1 60 90
                   L 100 90
                   L 100 50
          ...
          <path d="M100 90
                   ...
                   L 100 90
                   Z" fill="white"/>
          <circle cx="100" cy="100" r="92" stroke="#81B441" strokeWidth="1" strokeOpacity="0.3"/>
          <circle cx="100" cy="100" r="98" stroke="#81B441" strokeWidth="1" strokeOpacity="0.1"/>
                  </svg>
                </div>
      ...
      {currentStep === CheckInStep.Confirmation && selectedParticipant && (
        <div className="checkin-result">
          ...
          <div className="checkin-buttons-container">
            <button
              type="button"
              onClick={() => setCurrentStep(CheckInStep.TermsConditions)}
              className="checkin-button checkin-button-secondary"
            >
              Retour
            </button>
