...
export default function HorairesPage() {
  ...
  const fetchTimeSlots = async () => {
    try {
      setLoading(true);
      const response = await fetch(`/api/events/${id}/time-slots`);
      ...
      setTimeSlots([
        {
          ...
          endTime: "12:00",
          isActive: true,
          description: "Créneaux disponibles le matin",
        ...
        },
        {
          ...
          endTime: "17:00",
          isActive: true,
          description: "Créneaux disponibles l'après-midi",
          createdAt: new Date().toISOString()
        }
      ]);
    } finally {
  ...
  const handleSave = async () => {
    try {
      const url = editingSlot 
        ? `/api/events/${id}/time-slots/${editingSlot.id}`
        : `/api/events/${id}/time-slots`;
          ...
          <div className="p-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Gérez les créneaux horaires disponibles pour les rendez-vous
                </CardDescription>
              </CardHeader>
              <CardContent>
                {loading ? (
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {editingSlot 
                ...
                : "Créez un nouveau créneau horaire pour les rendez-vous"
              }
            </DialogDescription>
          </DialogHeader>
