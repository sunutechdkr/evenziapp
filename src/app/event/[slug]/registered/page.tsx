...
async function getRegistrationData(id: string): Promise<RegistrationWithEvent | null> {
  try {
    ...
    // IMPORTANT: On ne génère plus le QR code ici,
    // c'est le composant Badge qui s'en charge maintenant
    // pour garantir qu'il est toujours à jour avec le shortCode en base
